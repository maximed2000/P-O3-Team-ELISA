...
\title{% Geef hier de titel van je project in
                                              }
\author{% Geef de naam van de teamleden in, gescheiden door \\
                                                               }
\date{}
...
\vspace{2cm}
{\Large Titularis : % naam titularis}
\vspace{1cm}

{\Large Begeleider : % naam begeleider}
...
\subsubsection{Selectie uiteindelijk ontwerp}
Uiteindelijk werd gekozen voor het \textit{Concept} 3. De doorslaggevende factor was hierbij de kostprijs. In het eerste en tweede \textit{concept}
